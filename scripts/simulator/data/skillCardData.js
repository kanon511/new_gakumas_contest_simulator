...
export const skillCardData = [
    ...
    },
    {
        ...
        effects: [
            { type: 'status', target: '好調', value: 2 }, 
            { type: 'status', target: '之后5回合，每回合结束时，分数+4', value: 1 },  
        ],
        limit: 1,
        card_cost: 0,
        allow_duplicate: false,
    ...
    },
    {
        ...
        effects: [
            { type: 'status', target: 'やる気', value: 3 }, 
            { type: 'status', target: '好印象効果のスキルカード使用後、好印象の30%分パラメータ', value: 1 },
        ],
        limit: 1,
        card_cost: 0,
        allow_duplicate: false,
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: null, options: [{ type: '好印象', value: 1.2 }], condition: '好印象>=3' },
            { type: 'score', value: null, options: [{ type: 'block', value: 0.5 }], condition: 'やる気>=3' },
            { type: 'status', target: 'スキルカード使用数追加', value: 1 }, 
        ],
        limit: 1,
        card_cost: 96,
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: null, options: [{ type: '好印象', value: 1.5 }], condition: '好印象>=3' },
            { type: 'score', value: null, options: [{ type: 'block', value: 0.7 }], condition: 'やる気>=3' },
            { type: 'status', target: 'スキルカード使用数追加', value: 1 }, 
        ],
        limit: 1,
        card_cost: 126,
