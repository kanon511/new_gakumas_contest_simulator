...
export const skillCardData = [
    ...
    },
    {
        ...
        effects: [
            { type: 'status', target: '好調', value: 2 }, 
            { type: 'status', target: '5ターンの間ターン終了時スコア+4', value: 4, options: [{ type: 'value', value: 1 } ]}, 
        ],
        limit: 1,
        card_cost: 0,
        allow_duplicate: false,
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: 0, options: [{ type: '好印象', value: 120 }], condition: '好印象>=3' }, 
            { type: 'score', value: 0, options: [{ type: 'block', value: 50 }], condition: 'やる気>=3' }, 
            { type: 'status', target: 'スキルカード使用数追加', value: 1, }, 
        ],
        limit: 1,
        card_cost: 96,
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: 0, options: [{ type: '好印象', value: 150 }], condition: '好印象>=3' }, 
            { type: 'score', value: 0, options: [{ type: 'block', value: 70 }], condition: 'やる気>=3' }, 
            { type: 'status', target: 'スキルカード使用数追加', value: 1, }, 
        ],
        limit: 1,
        card_cost: 126,
