...
export const skillCardData = [
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: null, options: [{ type: '好調', value: 250 }] }, 
        ],
        limit: 1,
        card_cost: 0,
        allow_duplicate: false,
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: 6, options: [{ type: '集中', value: 1.5 }] }, 
            { type: 'block', value: 4, condition: 'hpPer<=50' }, 
        ],
        limit: 1,
        card_cost: 0,
        allow_duplicate: false,
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: 8, options: [{ type: '集中', value: 2 }] }, 
            { type: 'block', value: 7, condition: 'hpPer<=50' }, 
        ],
        limit: 1,
        card_cost: 0,
        allow_duplicate: false,
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'block', value: 2, options: [{ type: 'やる気', value: 1.5}] }, 
    ...
    },
    {
        ...
        effects: [
            { type: 'status', target: '集中', value: 1 },
            { type: 'status', target: 'ターン開始時、好調+2', value: 1 },
        ],
        limit: 1,
        card_cost: 0,
        allow_duplicate: false,
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: null, options: [{ type: '好印象', value: 120 }], condition: '好印象>=3' }, 
            { type: 'score', value: null, options: [{ type: 'block', value: 50 }], condition: 'やる気>=3' }, 
            { type: 'status', target: 'スキルカード使用数追加', value: 1, }, 
        ],
        limit: 1,
        card_cost: 96,
    ...
    },
    {
        ...
        condition: '',
        effects: [
            { type: 'score', value: null, options: [{ type: '好印象', value: 150 }], condition: '好印象>=3' }, 
            { type: 'score', value: null, options: [{ type: 'block', value: 70 }], condition: 'やる気>=3' }, 
            { type: 'status', target: 'スキルカード使用数追加', value: 1, }, 
        ],
        limit: 1,
        card_cost: 126,
    ...
    },
    {
        ...
        effects: [
            { type: 'block', value: 4 },
            { type: 'status', target: 'やる気', value: 4 },
            { type: 'status', target: '好印象', value: 3, condition: 'block>=30' }, 
        ],
        limit: 1,
        card_cost: 96,
        allow_duplicate: false,
